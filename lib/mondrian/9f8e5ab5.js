...
`),Ko=[{icon:Xo,value:"improve",text:"Improve writing"},{icon:zo,value:"proofread",text:"Fix spelling and grammar"},{icon:Jo,value:"shorten",text:"Make shorter"},{icon:Zo,value:"lengthen",text:"Make longer"},{icon:jo,value:"changeTone",text:"Change tone",submenu:[{value:"changeTone_professional",text:"Professional"},{value:"changeTone_casual",text:"Casual"},{value:"changeTone_straightforward",text:"Straightforward"},{value:"changeTone_confident",text:"Confident"},{value:"changeTone_friendly",text:"Friendly"},{value:"changeTone_custom",text:"Custom"}]},{icon:Go,value:"changeAudience",text:"Change audience"},{icon:_o,value:"simplify",text:"Simplify Writing"}],Wo=[{icon:Ro,value:"boldKeyTerms",text:"Bold key terms"},{icon:Eo,value:"addEmojis",text:"Add emojis"}],Qo=[{icon:$o,value:"continue",text:"Continue writing"},{icon:No,value:"explain",text:"Explain this"},{icon:No,value:"suggestImprovements",text:"Suggest improvements"},{icon:No,value:"findSynonyms",text:"Find synonyms"},{icon:No,value:"createAnalogy",text:"Create an analogy"},{icon:No,value:"createScenario",text:"Create a scenario"},{icon:No,value:"createKeyTakeaways",text:"Create key takeaways"},{icon:No,value:"createImagePrompt",text:"Create an AI image prompt"}],en=[{icon:No,value:"createHaiku",text:"Write a haiku"}],tn=[{icon:No,value:"writeAboutTopic",text:"Write about..."},{icon:No,value:"write1ParagraphAboutTopic",text:"Write 1 paragraph"},{icon:No,value:"write2ParagraphsAboutTopic",text:"Write 2 paragraphs"},{icon:No,value:"write3ParagraphsAboutTopic",text:"Write 3 paragraphs"}],an=[{icon:Fo,value:"replace",text:"Replace selection"},{icon:Bo,value:"append",text:"Insert below"},{icon:Po,value:"copy",text:"Copy"},{icon:$o,value:"continue",text:"Continue writing"},{icon:qo,value:"discard",text:"Cancel"}],rn=[{icon:Oo,value:"retry",text:"Try again"},{icon:qo,value:"discard",text:"Cancel"}],on={improve:{option:"improve"},proofread:{option:"proofread"},lengthen:{option:"lengthen"},shorten:{option:"shorten"},changeTone_professional:{option:"changeTone",params:{tone:"professional"}},changeTone_casual:{option:"changeTone",params:{tone:"casual"}},changeTone_straightforward:{option:"changeTone",params:{tone:"straightforward"}},changeTone_confident:{option:"changeTone",params:{tone:"confident"}},changeTone_friendly:{option:"changeTone",params:{tone:"friendly"}},changeTone_custom:{option:"changeTone"},changeAudience:{option:"changeAudience"},simplify:{option:"simplify"},copy:{option:"copy"},append:{option:"append"},replace:{option:"replace"},continue:{option:"continue"},discard:{option:"discard"},retry:{option:"retry"},boldKeyTerms:{option:"boldKeyTerms"},addEmojis:{option:"addEmojis"},explain:{option:"explain"},suggestImprovements:{option:"suggestImprovements"},findSynonyms:{option:"findSynonyms"},createAnalogy:{option:"createAnalogy"},createScenario:{option:"createScenario"},createKeyTakeaways:{option:"createKeyTakeaways"},createImagePrompt:{option:"createImagePrompt"},createHaiku:{option:"createHaiku"},writeAboutTopic:{option:"writeAboutTopic"},write1ParagraphAboutTopic:{option:"write1ParagraphAboutTopic"},write2ParagraphsAboutTopic:{option:"write2ParagraphsAboutTopic"},write3ParagraphsAboutTopic:{option:"write3ParagraphsAboutTopic"}};let nn=class extends Ao{constructor(){super(...arguments),this.menu="initial",this.submenuAnchor=this,this.handleMenuSubmit=e=>{const{detail:t}=e,a=on[t.value];a&&this.dispatchEvent(new CustomEvent("canned-option:submit",{detail:a}))},this.handleSubmenuTriggerClick=(e,t)=>{e.currentTarget instanceof HTMLElement&&(this.selected!==t?(this.selected=t,this.submenuAnchor=e.currentTarget):this.closeSubmenu())},this.openSubmenu=e=>{this.selected!==e.detail.value&&(this.selected=e.detail.value,this.submenuAnchor=e.detail.target)},this.closeSubmenu=()=>{this.selected=void 0,this.submenuAnchor=this},this.onMenuEscape=()=>{this.selected&&(this.selected=void 0,this.submenuAnchor=this)}}render(){return wo.qy`
    ...
    `}renderInitialMenuOptions(){return"initial"!==this.menu?wo.s6:wo.qy`
    ...
    `}renderReplyMenuOptions(){return"reply"!==this.menu?wo.s6:wo.qy`
      ${this.renderMenuItemGroup(an)}
      ${this.renderEditSelectionsOptions()}
      ${this.renderFormatSelectionOptions()}
    `}renderScratchMenuOptions(){return"scratch"!==this.menu?wo.s6:this.renderScratchOptions()}renderCanceledMenuOptions(){return"canceled"!==this.menu?wo.s6:wo.qy`${this.renderMenuItemGroup(rn)}`}renderEditSelectionsOptions(){return wo.qy`
      <strong class="menu-heading">Edit selection</strong>
      ${this.renderMenuItemGroup(Ko)}
    `}renderFormatSelectionOptions(){return wo.qy`
      <strong class="menu-heading">Format selection</strong>
      ${this.renderMenuItemGroup(Wo)}
    `}renderGenerateFromSelectionOptions(){return wo.qy`
      <strong class="menu-heading">Generate from selection</strong>
      ${this.renderMenuItemGroup(Qo)}
    `}renderPromptOptions(){return wo.qy`
      <strong class="menu-heading">Prompt</strong>
      ${this.renderMenuItemGroup(en)}
    `}renderScratchOptions(){return wo.qy`
      <strong class="menu-heading">Generate from scratch</strong>
      ${this.renderMenuItemGroup(tn)}
    `}renderMenuItemGroup(e){return wo.qy`
      ${e.map((e=>e.submenu?.length?wo.qy`
            <mon-menu-item
              value=${e.value}
              data-has-icons
        ...
        `))}
    `}renderSubmenu({submenu:e,value:t}){return t===this.selected&&e?wo.qy`
        <mon-popover
      ...
      `:wo.qy``}};nn.styles=Uo,(0,Io.Cg)([(0,Lo.MZ)({type:String})],nn.prototype,"menu",void 0),(0,Io.Cg)([(0,Lo.wk)()],nn.prototype,"submenuAnchor",void 0),(0,Io.Cg)([(0,Lo.wk)()],nn.prototype,"selected",void 0),nn=(0,Io.Cg)([(0,Lo.EM)("mon-ai-writer-canned-options")],nn);var sn=a(5494),ln=a(6394),cn=a(1959),dn=a(2602),hn=a.n(dn),pn=a(5792);class un{constructor({onCancel:e,onDone:t,onResult:a,onSubmitted:i,fetch:r}){if(this.sessionId=window.crypto.randomUUID(),this.process=async(e,t)=>{const{onDone:a,onResult:i,onSubmitted:r}=this;r();const o=await this.fetch(this.sessionId,e,{signal:t.signal});if(!t.signal.aborted){const a=o.pipeThrough(new mn).getReader(),r=()=>{this.onCancel(),a.cancel()};t.signal.addEventListener("abort",r);try{await a.read().then((function t({done:r,value:o}){if(!r)return i({input:e,output:o}),a.read().then(t)}))}finally{t.signal.removeEventListener("abort",r)}}a()},!r)throw new Error("AI Writer must be initialized with a defined AIResponseFetcher function");this.onCancel=e,this.onDone=t,this.onResult=a,this.onSubmitted=i,this.fetch=r}}class mn extends TransformStream{static _guardHtml(e){const t=e.lastIndexOf("<");return-1===t||-1!==e.slice(t+1).indexOf(">")}constructor(e){let t=e?.response??"";super({start(a){null!=e&&a.enqueue(t)},transform(e,a){t+=e,mn._guardHtml(t)&&a.enqueue(t)}})}}const gn=e=>{class t extends e{constructor(){super(...arguments),this.initialContent="",this.aiResponseFetcher=void 0,this.courseId="mondrian-test",this.status="prompt",this.userInput="",this.aiResponses=[],this.selectedResponseIndex=0,this.updateLastResponse=hn()((e=>{const t=[...this.aiResponses],a=t.pop();a&&(this.aiResponses=[...t,{...a,...e}])}),64),this.addNewResponse=()=>{this.aiResponses=[...this.aiResponses,{prompt:this.userInput,response:"",menu:"reply"}],this.selectedResponseIndex=this.aiResponses.length-1},this.incrementResponseIndex=()=>{this.selectedResponseIndex<=this.aiResponses.length-1&&this.selectedResponseIndex++},this.decrementResponseIndex=()=>{this.selectedResponseIndex>0&&this.selectedResponseIndex--},this.handleInput=e=>{this.userInput=e.target.value},this.submitInput=()=>{this.userInput.length&&this.requestResult({content:this.contentForSubmit||"<p> </p>",key:"custom",prompt:this.userInput})},this.requestResult=e=>{this.abortController=new AbortController,this.aiStreamInstance.process({...e,courseId:this.courseId,wentBack:this.wentBack},this.abortController).catch((e=>{("AbortError"!==e.name||e instanceof pn.AbortError)&&(this.status="error")}))},this.fillPrompt=e=>{const t=vn[e];t&&(this.userInput=`${t} `)},this.handleCannedOption=({option:e,params:t})=>{switch(e){case"changeTone":t&&t.tone?this.requestResult({content:this.contentForSubmit,key:e,tone:t.tone}):this.fillPrompt(e);break;case"changeAudience":case"createBulletedList":case"createNumberedList":case"createTable":case"writeAboutTopic":case"write1ParagraphAboutTopic":case"write2ParagraphsAboutTopic":case"write3ParagraphsAboutTopic":this.fillPrompt(e);break;case"continue":this.requestResult({content:this.contentForSubmit,key:e});break;case"append":this.dispatchEvent(new CustomEvent("append",{detail:this.contentForSubmit}));break;case"replace":this.dispatchEvent(new CustomEvent("replace",{detail:this.contentForSubmit}));break;case"copy":navigator.clipboard.writeText(this.contentForSubmit).then((()=>{console.log("copied to clipboard")}));break;case"discard":this.dispatchEvent(new CustomEvent("blur"));break;case"retry":{const{retry:e}=this.currentResponse;e&&this.requestResult(e[0]);break}default:this.requestResult({content:this.contentForSubmit,key:e,...t??{}})}},this.stopGeneratingAIResponse=()=>{this.abortController&&this.abortController.abort();const e=this.aiResponses[this.aiResponses.length-1];e.response?.length||(this.aiResponses.pop(),this.decrementResponseIndex()),this.status="prompt"}}get currentMenu(){return this.currentResponse.menu??"initial"}get currentResponse(){return 0===this.aiResponses.length?fn(this.initialContent):this.aiResponses[this.selectedResponseIndex]}get responseCount(){return this.aiResponses.length}get displayedResult(){const{currentResponse:e}=this;return function(e){const t=document.createElement("div");return t.innerHTML=e,t.querySelectorAll("[style]").forEach((e=>{e.removeAttribute("style")})),t.innerHTML}(e.response||this.initialContent)}get contentForSubmit(){const e=this.currentResponse.response||this.initialContent;return"<p></p>"===e?"<p> </p>":e}get wentBack(){return Math.max(this.aiResponses.length-this.selectedResponseIndex-1,0)}get aiStreamInstance(){return this.aiStream||(this.aiStream=new un({onCancel:()=>{this.currentResponse.menu="canceled"},onDone:()=>{this.status="prompt",this.userInput=""},onResult:({input:e,output:t})=>{try{"streaming"!==this.status&&(this.status="streaming"),this.updateLastResponse({response:t,retry:[e]})}catch{this.status="error"}},onSubmitted:()=>{this.status="pending",this.addNewResponse()},fetch:this.aiResponseFetcher})),this.aiStream}connectedCallback(){super.connectedCallback(),this.aiResponses.length||this.aiResponses.push(fn(this.initialContent))}}return(0,Io.Cg)([(0,Lo.MZ)({type:String})],t.prototype,"initialContent",void 0),(0,Io.Cg)([(0,Lo.MZ)()],t.prototype,"aiResponseFetcher",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:String})],t.prototype,"courseId",void 0),(0,Io.Cg)([(0,Lo.wk)()],t.prototype,"status",void 0),(0,Io.Cg)([(0,Lo.wk)()],t.prototype,"userInput",void 0),(0,Io.Cg)([(0,Lo.wk)()],t.prototype,"aiResponses",void 0),(0,Io.Cg)([(0,Lo.wk)()],t.prototype,"selectedResponseIndex",void 0),t},vn={changeAudience:"Rewrite this for an intended audience of",changeTone:"Change the tone to",createBulletedList:"Write a bulleted list about",createNumberedList:"Write a numbered list about",createTable:"Create a table about",writeAboutTopic:"Write about",write1ParagraphAboutTopic:"Write 1 paragraph about",write2ParagraphsAboutTopic:"Write 2 paragraphs about",write3ParagraphsAboutTopic:"Write 3 paragraphs about"};function fn(e){const t=document.createElement("div");return t.innerHTML=e,{prompt:"",response:e,menu:t.innerText.trim().length>0?"initial":"scratch"}}const bn=wo.AH`
  :host * {
    box-sizing: border-box;
...
`;let Sn=class extends(gn(Ao)){constructor(){super(...arguments),this.offset=12,this.positionConfig={middleware:[(0,sn.cY)(this.offset)]},this.stopMouseEventPropagation=!1,this.inputRef=(0,ln._)(),this.resultsMutationObserver=new MutationObserver((()=>{const e=this.$(".response");e&&e.scrollTo(0,e.scrollHeight)})),this.handleInputSubmit=e=>{e.preventDefault(),this.submitInput()},this.handleCannedOptionSelect=e=>{this.handleCannedOption(e.detail)},this.maybeStopPropagation=e=>{this.stopMouseEventPropagation&&this.stopPropagation(e)},this.stopPropagation=e=>{e.stopPropagation()},this.handleBlur=e=>{this.dispatchEvent(new CustomEvent("blur"))},this.handlePaginationClick=e=>{const t=e.currentTarget;"decrement"===t.name&&this.decrementResponseIndex(),"increment"===t.name&&this.incrementResponseIndex(),this.status="prompt"}}get isGenerating(){return["pending","streaming"].includes(this.status)}willUpdate(e){const t=e.get("status"),a=this.status,i=this.$(".response");i&&("streaming"!==t&&"streaming"===a&&this.resultsMutationObserver.observe(i,{subtree:!0,childList:!0}),"streaming"===t&&"prompt"===a&&this.resultsMutationObserver.disconnect())}renderSubmitButton(){if(!this.isGenerating){const e=this.userInput.length<=0;return wo.qy`
      ...
      `}}renderResponseContents(){return"error"===this.status?wo.qy`<span class="errorMessage">An error occurred</span>`:["prompt","streaming"].includes(this.status)?wo.qy`<span>${(0,cn._)(this.displayedResult)}</span>`:wo.qy`<span>Loading...</span>`}renderResponse(){return"scratch"===this.currentMenu?wo.s6:wo.qy`<div class="response">${this.renderResponseContents()}</div>`}renderPopoverContent(){return wo.qy`
      <div class="content">
        <div class="body">
          ${this.renderResponse()}
          <div class="input-section">
            <div class="decorative-icons">${Vo}</div>
            <form @submit=${this.handleInputSubmit}>
              <input
                ${(0,ln.K)(this.inputRef)}
    ...
    `}firstUpdated(e){super.firstUpdated(e),this.inputRef.value&&window.requestAnimationFrame((()=>{this.inputRef.value?.focus()}))}renderCannedOptionMenu(){if(!this.isGenerating)return wo.qy`
        <mon-ai-writer-canned-options
          @canned-option:submit=${this.handleCannedOptionSelect}
          .menu=${this.currentMenu}
        ></mon-ai-writer-canned-options>
      `}renderMiscActions(){return this.isGenerating?wo.qy`
        <div class="stop">
          <button @click=${this.stopGeneratingAIResponse}>
            Stop generating
          </button>
        </div>
      `:this.renderPagination()}renderPagination(){const{responseCount:e,selectedResponseIndex:t}=this,a=t+1;if(this.responseCount>1)return wo.qy`
    ...
    `}};Sn.styles=bn,(0,Io.Cg)([(0,Lo.MZ)({type:Number})],Sn.prototype,"offset",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Object})],Sn.prototype,"positionConfig",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Boolean})],Sn.prototype,"stopMouseEventPropagation",void 0),(0,Io.Cg)([(0,Lo.wk)()],Sn.prototype,"inputRef",void 0),Sn=(0,Io.Cg)([(0,Lo.EM)("mon-ai-writer")],Sn);var Cn=a(6678),yn=a(1514);const In=wo.AH`
...
`;let wn=class extends Ao{constructor(){super(...arguments),this.closeOnBackgroundClick=!1,this.disableClose=!1,this.animationDuration=250,this.open=!1,this.titleText="",this.noBackdrop=!1,this.dialogStyles={},this.closing=!1}async updated(e){if(super.updated(e),e.has("open")){const t=e.get("open");t||!0!==this.open?t&&!1===this.open&&this.closeModal():this.dialog?.showModal()}}handleBGClick(e){this.closeOnBackgroundClick&&e.target===this.dialog&&this.closeModal()}handleKeyDown(e){"Escape"===e.key&&(e.preventDefault(),e.stopPropagation(),this.closeModal())}closeModal(){this.dialog.open&&!this.closing&&(this.closing=!0,setTimeout((()=>{this.dialog.close(),this.dispatchEvent(new CustomEvent("artDialogClosed",{bubbles:!0,composed:!0})),this.closing=!1}),this.animationDuration))}connectedCallback(){super.connectedCallback(),this.style.setProperty("--animation-duration",`${this.animationDuration}ms`)}render(){const e={"no-backdrop":this.noBackdrop,open:this.open,closing:this.closing};return wo.qy`
      ...
      >
        <div class="dialog-wrap">
          ...
          <div class="dialog-header">
            <slot name="title">
              ${this.titleText?wo.qy`<h1>${this.titleText}</h1>`:wo.s6}
            </slot>
            ${this.disableClose?wo.s6:wo.qy`
                  <button
                    class="close-button"
    ...
    `}};wn.styles=In,(0,Io.Cg)([(0,Lo.P)("dialog")],wn.prototype,"dialog",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Boolean})],wn.prototype,"closeOnBackgroundClick",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Boolean})],wn.prototype,"disableClose",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Number})],wn.prototype,"animationDuration",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Boolean})],wn.prototype,"open",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:String})],wn.prototype,"titleText",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Boolean})],wn.prototype,"noBackdrop",void 0),(0,Io.Cg)([(0,Lo.MZ)({attribute:!1})],wn.prototype,"dialogStyles",void 0),(0,Io.Cg)([(0,Lo.wk)()],wn.prototype,"closing",void 0),wn=(0,Io.Cg)([(0,Lo.EM)("art-modal")],wn);const xn=wo.AH`
  * {
    box-sizing: border-box;
    font-size: 10px;
  }
...
`;let kn=class extends Ao{constructor(){super(...arguments),this.slot="tab",this.label="",this.role="tab",this.value="",this["aria-selected"]="false",this.selected=!1,this.disabled=!1,this.tabIndex=-1,this.bindEvents=()=>{this.on("click",this.onClick)}}onClick(){this.dispatch("art-tab:change")}render(){return wo.qy`
      <span class="content">
        <slot name="icon"></slot>
    ...
    `}};kn.styles=xn,(0,Io.Cg)([(0,Lo.MZ)({type:String,reflect:!0})],kn.prototype,"slot",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:String})],kn.prototype,"label",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:String,reflect:!0})],kn.prototype,"role",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:String})],kn.prototype,"value",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:String,reflect:!0})],kn.prototype,"aria-selected",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Boolean,reflect:!0})],kn.prototype,"selected",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Boolean,reflect:!0})],kn.prototype,"disabled",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:String,reflect:!0})],kn.prototype,"aria-controls",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Number,reflect:!0})],kn.prototype,"tabIndex",void 0),kn=(0,Io.Cg)([(0,Lo.EM)("art-tab")],kn);const Mn=wo.AH`
  * {
    box-sizing: border-box;
  }
`;let Tn=class extends Ao{constructor(){super(...arguments),this.value="",this.slot="panel"}render(){return wo.qy`
      <div
        role="tabpanel"
        id=${this.id}
      >
    ...
    `}};Tn.styles=Mn,(0,Io.Cg)([(0,Lo.MZ)({type:String})],Tn.prototype,"value",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:String,reflect:!0})],Tn.prototype,"slot",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:String,reflect:!0})],Tn.prototype,"aria-labelledby",void 0),Tn=(0,Io.Cg)([(0,Lo.EM)("art-tab-panel")],Tn);const Ln=wo.AH`
  * {
    box-sizing: border-box;
  }
...
`;let An=class extends Ao{constructor(){super(...arguments),this.autofocusit=!0,this.value=null,this.stickyHeaderPosition=-1,this.tabFocus=0,this.bindEvents=()=>{this.on("art-tab:change",this.onChange),this.on("keydown",this.onKeydown)},this.onChange=e=>{e.target instanceof kn&&(this.value=e.target.value??null,this.syncTabStates(),this.dispatch("art-tabs:change",{value:this.value}))},this.onKeydown=e=>{if(!(e.target instanceof kn))return;const{key:t}=e;if(["ArrowLeft","ArrowRight","ArrowUp","ArrowDown"].includes(t)){const e=this.$$$("art-tab","tab");"ArrowRight"===t||"ArrowUp"===t?(this.tabFocus++,this.tabFocus>=e.length&&(this.tabFocus=0)):"ArrowLeft"===t||"ArrowDown"===t?(this.tabFocus--,this.tabFocus<0&&(this.tabFocus=e.length-1)):"Home"===t?this.tabFocus=0:"End"===t&&(this.tabFocus=e.length-1),this.value=e[this.tabFocus].value,this.syncTabStates()}},this.focusFirstApplicableItem=()=>{this.value=this.$selected?.value??this.$$$("art-tab","tab")[0]?.value,this.syncTabStates(),this.dispatch("art-tabs:change",{value:this.value})},this.onTabSlotChange=()=>{this.autofocusit&&this.focusFirstApplicableItem(),this.syncAriaLabels()},this.syncAriaLabels=()=>{const e=this.$$$("art-tab-panel","panel");this.$$$("art-tab","tab").forEach(((t,a)=>{const i=`art-tabs-tab-${a}`;t.id=i,e.forEach(((e,a)=>{if(e.value===t.value){const r=`art-tabs-tab-panel-${a}`;e.id=r,e.setAttribute("aria-labelledby",i),t.setAttribute("aria-controls",r)}}))}))},this.syncTabStates=()=>{this.$$$("art-tab","tab").forEach(((e,t)=>{const a=e.value===this.value;e.toggleAttribute("selected",a),e.setAttribute("aria-selected",a.toString()),e.tabIndex=a?0:-1,a&&(this.tabFocus=t,e.focus())})),this.$$$("art-tab-panel","panel").forEach((e=>{e.toggleAttribute("hidden",this.value!==e.value)}))}}get $selected(){return this.$$$("art-tab[selected]")[0]}update(e){super.update(e),e.has("value")&&this.value!==e.get("value")&&this.syncTabStates()}render(){return wo.qy`
    ...
    `}};An.styles=Ln,(0,Io.Cg)([(0,Lo.MZ)({type:Boolean,reflect:!0})],An.prototype,"autofocusit",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:String,reflect:!0})],An.prototype,"value",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Number})],An.prototype,"stickyHeaderPosition",void 0),An=(0,Io.Cg)([(0,Lo.EM)("art-tabs")],An);const Rn=wo.AH`
  :host {
    margin: 0;
    border: none;
    padding: 0;
  }
`;let Bn=class extends Ao{constructor(){super(...arguments),this.offsets={x:0,y:0},this.anchor=null,this.positionConfig={},this.strategy="fixed",this.isPopover=!0,this.updatePosition=async()=>{const{anchor:e,style:t}=this;if(e&&t){const{x:a,y:i}=await(0,sn.rD)(e,this,{placement:"bottom",strategy:this.strategy,middleware:[(0,sn.UU)(),(0,sn.BN)(),(0,sn.cY)(12)],...this.positionConfig});t.top=`${i}px`,t.left=`${a}px`}},this.checkClickOutside=e=>{const{anchor:t}=this;t&&!e.composedPath().includes(t)&&this.dispatchEvent(new CustomEvent("blur"))},this.handleMove=({pageX:e,pageY:t})=>{this.style.left=e-this.offsets.x+"px",this.style.top=t-this.offsets.y+"px"}}connectedCallback(){super.connectedCallback();const{anchor:e}=this;e&&(this.isPopover?(this.popover||(this.popover="manual",this.showPopover()),this.collectOff((0,sn.ll)(e,this,this.updatePosition))):this.style.position="relative",this.onmousedown=({pageX:e,pageY:t})=>(this.offsets.x=e-this.offsetLeft,this.offsets.y=t-this.offsetTop,window.addEventListener("mousemove",this.handleMove,!0),!1),this.onmouseup=()=>(window.removeEventListener("mousemove",this.handleMove,!0),!1)),window.addEventListener("mousedown",this.checkClickOutside,{capture:!0,passive:!0})}disconnectedCallback(){super.disconnectedCallback(),this.isPopover&&this.hidePopover(),this.onmousedown=null,this.onmouseup=null,window.removeEventListener("mousedown",this.checkClickOutside,{capture:!0})}render(){return wo.qy`
      <div class="mon-draggable">
        <slot></slot>
      </div>
    `}};Bn.styles=Rn,(0,Io.Cg)([(0,Lo.MZ)()],Bn.prototype,"anchor",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Object})],Bn.prototype,"positionConfig",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:String})],Bn.prototype,"strategy",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Boolean})],Bn.prototype,"isPopover",void 0),Bn=(0,Io.Cg)([(0,Lo.EM)("mon-draggable")],Bn);const Fn=wo.AH`
  * {
    box-sizing: border-box;
  }
...
`;let Pn=class extends Ao{constructor(){super(...arguments),this.selected=!1,this.tabIndex=-1,this.role="menuitem",this.delegatesFocus=!1,this.focusableRef=(0,ln._)(),this.bindEvents=()=>{this.on("mouseenter",(()=>{this.dispatch("hover",{value:this.value,hovered:!0})})),this.on("click",this.onClick),this.on("focus",(()=>{if(this.delegatesFocus){const e=this.querySelector('a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])');e instanceof HTMLElement&&e.focus()}}))}}onClick(){this.dispatch("mon-menu-item:select")}render(){return wo.qy`
      <slot name="icon"></slot>
      <div class="content">
        <slot></slot>
        <div class="extras">
    ...
    `}};Pn.formAssociated=!0,Pn.styles=Fn,Pn.shadowRootOptions={...wo.WF.shadowRootOptions,delegatesFocus:!1},(0,Io.Cg)([(0,Lo.MZ)({type:String,reflect:!0})],Pn.prototype,"value",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Boolean,reflect:!0})],Pn.prototype,"selected",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Number,reflect:!0})],Pn.prototype,"tabIndex",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:String,reflect:!0})],Pn.prototype,"role",void 0),(0,Io.Cg)([(0,Lo.MZ)()],Pn.prototype,"delegatesFocus",void 0),(0,Io.Cg)([(0,Lo.wk)()],Pn.prototype,"focusableRef",void 0),Pn=(0,Io.Cg)([(0,Lo.EM)("mon-menu-item")],Pn);const Vn=wo.AH`
  * {
    box-sizing: border-box;
  }
...
`,Jn={enabled:!1,padding:0,boundary:"clippingAncestors",prioritizeResize:!1,minResizeHeight:0,minResizeWidth:0,enableShiftCrossAxis:!1,flipPadding:0,shiftPadding:0,maxResizeHeight:1/0,maxResizeWidth:1/0,avoidFlipOverlap:!1,matchAnchorWidth:!1};let $n=class extends Ao{constructor(){super(...arguments),this.autoFlip=!0,this.autoResizeOptions={},this.customMiddleware=[],this.autoShift=!0,this.semantic=!1,this.enableAutoUpdates=!0,this.semanticPriority=0,this.offset=10,this.placement="bottom",this.sizeMiddlewareOptions={...Jn,...this.autoResizeOptions},this.middleware=[],this.syncMiddleware=()=>{this.sizeMiddlewareOptions={...Jn,...this.autoResizeOptions};const e=this.sizeMiddlewareOptions.avoidFlipOverlap,t=this.sizeMiddlewareOptions.minResizeWidth,a=this.sizeMiddlewareOptions.maxResizeWidth,i=this.sizeMiddlewareOptions.minResizeHeight,r=this.sizeMiddlewareOptions.maxResizeHeight,o=this.sizeMiddlewareOptions.matchAnchorWidth,n="number"==typeof this.sizeMiddlewareOptions.shiftPadding?this.sizeMiddlewareOptions.shiftPadding:this.sizeMiddlewareOptions.shiftPadding.top??0,s=this.sizeMiddlewareOptions.enabled&&(0,sn.Ej)({apply({availableWidth:s,availableHeight:l,elements:c,rects:d,y:h,placement:p}){const u=r?`${r}px`:"",m=[l,r,window.innerHeight-n];if(e){const e=c.reference.getBoundingClientRect().top;e>h&&p.includes("top")&&m.push(window.innerHeight-(window.innerHeight-e)-n)}const g=`${Math.max(i,Math.min(...m))}px`;c.floating.style.maxHeight=l>=c.floating.scrollHeight?u:g,c.floating.style.maxWidth=`${Math.max(t,Math.min(a,s))}px`,o&&(c.floating.style.minWidth=`${d.reference.width}px`)},padding:this.sizeMiddlewareOptions.padding,boundary:this.sizeMiddlewareOptions.boundary}),l=this.autoShift&&(0,sn.BN)({crossAxis:this.sizeMiddlewareOptions.enableShiftCrossAxis,padding:this.sizeMiddlewareOptions.shiftPadding}),c=(0,sn.cY)(this.offset);this.sizeMiddlewareOptions.prioritizeResize?this.middleware=[s,this.autoFlip&&(0,sn.UU)({fallbackStrategy:"initialPlacement",flipAlignment:!1,padding:this.sizeMiddlewareOptions.flipPadding}),l,...this.customMiddleware,c].filter((e=>!!e)):this.middleware=[this.autoFlip&&(0,sn.UU)({padding:this.sizeMiddlewareOptions.flipPadding}),l,s,...this.customMiddleware,c].filter((e=>!!e))},this.updatePosition=()=>{this.anchor&&(0,sn.rD)(this.anchor,this,{placement:this.placement,strategy:"fixed",middleware:this.middleware}).then((({x:e,y:t})=>{this.style.left=`${e}px`,this.style.top=`${t}px`}))}}updated(e){if(super.updated(e),Array.from(e.keys()).some((e=>["autoFlip","autoShift","autoResizeOptions","customMiddleware","offset"].includes(e)))&&this.syncMiddleware(),e.has("semantic")&&(this.semantic?(this.hasAttribute("popover")||(this.setAttribute("popover","manual"),function(e,t){const a=[];let i;{let r=0;for(;r<Qi.length;r+=1){const e=Qi[r];if(e.order>t)break;a.push(e)}for(i=r,a.push({element:e,order:t});r<Qi.length;r+=1){const e=Qi[r];e.element.hidePopover(),a.push(e)}}for(let e=i;e<a.length;e+=1)a[e].element.showPopover();Qi=a}(this,this.semanticPriority)),this.collectOff((()=>{this.hasAttribute("popover")&&(er(this),this.removeAttribute("popover"))}))):this.hasAttribute("popover")&&(er(this),this.removeAttribute("popover"))),e.has("anchor")&&this.anchor)if(this.enableAutoUpdates){this.autoUpdateDisposer&&this.autoUpdateDisposer();const e=(0,sn.ll)(this.anchor,this,this.updatePosition,{animationFrame:!0});this.collectOff(e),this.autoUpdateDisposer=e}else this.updatePosition()}render(){return wo.qy`<slot></slot>`}};$n.styles=Dn,(0,Io.Cg)([(0,Lo.MZ)()],$n.prototype,"anchor",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Boolean})],$n.prototype,"autoFlip",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Object})],$n.prototype,"autoResizeOptions",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Array})],$n.prototype,"customMiddleware",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Boolean})],$n.prototype,"autoShift",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Boolean,reflect:!0})],$n.prototype,"semantic",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Boolean})],$n.prototype,"enableAutoUpdates",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Number,reflect:!0})],$n.prototype,"semanticPriority",void 0),(0,Io.Cg)([(0,Lo.MZ)()],$n.prototype,"offset",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:String})],$n.prototype,"placement",void 0),$n=(0,Io.Cg)([(0,Lo.EM)("mon-popover")],$n);const Zn=wo.AH`
  * {
    box-sizing: border-box;
  }
...
`;let On=class extends Ao{constructor(){super(...arguments),this.value=null,this.popoverPlacement="bottom-end",this.placeholder="Choose an item...",this.open=!1,this.labelText="",this.anchorRef=(0,ln._)(),this.scrollBarWidth=tr,this.cancel=()=>{this.open&&(this.dispatch("mon-select:cancel"),this.dispatch("mon-select:close")),this.open=!1},this.onMenuEscape=()=>{this.cancel()},this.onSubmit=e=>{this.open=!1,e.stopPropagation(),this.dispatch("mon-select:close"),this.dispatch("mon-select:change",{name:this.name,value:e.detail.value})},this.onClickOutside=()=>{this.cancel()},this.onClickTrigger=()=>{this.open?this.cancel():(this.open=!0,this.dispatch("mon-select:open"))},this.onKeyDown=e=>{"ArrowLeft"===e.key&&e.stopPropagation()},this.onButtonKeyDown=e=>{"Enter"===e.key?e.preventDefault():"ArrowDown"===e.key&&(e.stopPropagation(),this.open=!0,this.dispatch("mon-select:open"))},this.onSlotChange=()=>{this.syncLabelText()},this.syncLabelText=()=>{this.labelText=this.$$$("mon-menu-item")?.filter((e=>e.value===this.value))[0]?.innerText??this.placeholder},this.handleRefChange=e=>{this.anchorRef=e}}get $selected(){return this.$$$("mon-menu-item[selected]")[0]}bindEvents(){this.on("mon-menu:escape",this.onMenuEscape),this.on("keydown",this.onKeyDown),this.collectOff(ko("mousedown",window,(e=>{const t=e.composedPath();e.target instanceof Node&&!t.includes(this)&&this.onClickOutside()}),{capture:!0,passive:!0}))}updated(e){e.has("value")&&this.syncLabelText(),this.open&&!1===e.get("open")&&window.requestAnimationFrame((()=>{const e=this.$$$("mon-menu-item")?.find((e=>e.value===this.value));e?.scrollIntoView({behavior:"instant",block:"nearest"})}))}renderTrigger(){return wo.qy`
    ...
    `}renderMenu(){return this.open?wo.qy`
          <mon-popover
        ...
        ></slot>`}render(){return wo.qy`${this.renderTrigger()}${this.renderMenu()}`}};On.styles=Zn,(0,Io.Cg)([(0,Lo.MZ)({type:String,reflect:!0})],On.prototype,"name",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:String})],On.prototype,"value",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:String})],On.prototype,"popoverPlacement",void 0),(0,Io.Cg)([(0,Lo.MZ)()],On.prototype,"placeholder",void 0),(0,Io.Cg)([(0,Lo.wk)()],On.prototype,"open",void 0),(0,Io.Cg)([(0,Lo.wk)()],On.prototype,"labelText",void 0),(0,Io.Cg)([(0,Lo.wk)()],On.prototype,"anchorRef",void 0),(0,Io.Cg)([(0,Lo.wk)()],On.prototype,"scrollBarWidth",void 0),On=(0,Io.Cg)([(0,Lo.EM)("mon-select")],On);const _n=wo.AH`
  *,
  *:before,
  *:after {
    box-sizing: border-box;
...
`;let Hn=class extends Ao{constructor(){super(...arguments),this.focusedByClick=!1,this.animationDuration=250}toggleSwitch(e){!0===e?this.toggle?.classList.add("active"):!1===e?this.toggle?.classList.remove("active"):this.toggle?.classList.toggle("active")}handleClick(){this.focusedByClick=!0,this.checkboxes[0].checked=!this.checkboxes[0].checked,this.checkboxes[0].dispatchEvent(new Event("change")),setTimeout((()=>{this.focusedByClick=!1}))}handleFocus(){setTimeout((()=>{!1===this.focusedByClick&&this.toggleVisibleFocus(!0)}))}handleBlur(){this.toggleVisibleFocus(!1)}toggleVisibleFocus(e){!0===e?this.toggle.classList.add("in-focus"):this.toggle.classList.remove("in-focus")}handleCheckboxChange(e){const t=e.target;this.toggleSwitch(t.checked)}handleKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),this.handleClick())}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.checkboxes.forEach((e=>{this.toggleSwitch(e.checked),e.style.left="0",e.style.opacity="0.01",e.style.outline="none !important",e.style.position="absolute",e.style.top="0",e.addEventListener("focus",this.handleFocus.bind(this)),e.addEventListener("blur",this.handleBlur.bind(this)),e.addEventListener("change",this.handleCheckboxChange.bind(this)),e.addEventListener("keydown",this.handleKeydown.bind(this))}))}render(){return wo.qy`
    ...
    `}};Hn.styles=_n,(0,Io.Cg)([(0,Lo.P)(".toggle")],Hn.prototype,"toggle",void 0),(0,Io.Cg)([(0,Lo.P)(".control")],Hn.prototype,"control",void 0),(0,Io.Cg)([(0,Lo.KN)({selector:'input[type="checkbox"]'})],Hn.prototype,"checkboxes",void 0),(0,Io.Cg)([(0,Lo.wk)()],Hn.prototype,"focusedByClick",void 0),(0,Io.Cg)([(0,Lo.MZ)({type:Number})],Hn.prototype,"animationDuration",void 0),Hn=(0,Io.Cg)([(0,Lo.EM)("mon-toggle")],Hn);const Yn=(e,t)=>{const a=t.cssText,i=new WeakSet;return t=>{const r=t.getRootNode();if(!i.has(r)){i.add(r);const t=(r instanceof ShadowRoot?r.ownerDocument:r instanceof Document?r:document).createElement("style");t.setAttribute("data-svelte-lit-styles",e),t.textContent=a,r.appendChild(t)}}},jn=wo.AH`
  &[data-flex='1'] {
...
`),i.Dn('<svg viewBox="0 0 100 100" data-element="button-spinner"><circle data-element="spinner-circle" cx="50%" cy="50%" r="45%" stroke-width="12.5%" pathLength="1"></circle><circle data-element="spinner-progress" cx="50%" cy="50%" r="45%" stroke-width="12.5%" pathLength="1"></circle></svg>'),i.vs('<span data-element="button-content"><!></span> <!>',1),i.vs('<a arc-button=""><!></a>'),i.vs('<button arc-button=""><!></button>');const Kn=wo.AH`
